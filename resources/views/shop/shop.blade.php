                            ...
                            <div class="col-md-4 product-men mt-5">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item text-center">
                                        <img src="/storage/products/{{ $newproduct->image }}" alt="" class="card-img">
                                        <div class="men-cart-pro">
                                            <div class="inner-men-cart-pro">
                                                <a class="link-product-add-cart" href="{{ route('galleryshop', $newproduct->id) }}">
                                                Quick View
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="item-info-product text-center border-top mt-4">
                                        <h4 class="pt-1">
                                            <a href="">{{ $newproduct->pro_name }}</a>
                                        </h4>
                                        <div class="info-product-price my-2">
                                            <span class="item_price">Ksh {{ $newproduct->pro_price }} M</span>
                                            <del>No Discount</del>
                                        </div>
                                        <div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
                                            <a href="{{ route('galleryshop', $newproduct->id) }}" class="button btn btn-outline-info pull-left btn-sm">Quick View</a>
                                            <a 
                                                href="{{ route('product.addToCart', ['id' => $newproduct->id])}}" 
                                                class="button btn btn-outline-success btn-sm pull-right"
                                                >
                                                Add to cart
                                            </a>
                                        </div>
                            ...
                            <div class="col-md-4 product-men mt-5">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item text-center">
                                        ...
                                        <div class="men-cart-pro">
                                            <div class="inner-men-cart-pro">
                                                <a class="link-product-add-cart" href="{{ route('galleryshop', $product->id) }}">
                                                Quick View
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="item-info-product text-center border-top mt-4">
                                        ...
                                        <div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
                                            <a href="{{ route('galleryshop', $product->id) }}" class="button btn btn-outline-info pull-left btn-sm">Quick View</a>
                                            <a 
                ...
                <div class="side-bar p-sm-4 p-3">
                    ...
                    <div class="range border-bottom py-2">
                        ...
                        @foreach($categories as $category)
                            <li class="nav-link">
                                <a href="{{ route('categoryshop', $product->category->name) }}">
                                    {{ $category->name }}
                                </a>                               
                            </li> 
                        @endforeach                           
