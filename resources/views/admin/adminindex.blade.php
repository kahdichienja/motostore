        ...
        <div class="content-wrapper">   
          <div class="row purchace-popup">
            <div class="col-12">
              <span class="d-block d-md-flex align-items-center">
                <p>Like what you see? Incase of Any Problem:</p>
                <a class="btn ml-auto download-button d-none d-md-block" href="" target="_blank">Developer Contact: +254797324006</a>
                <a class="btn purchase-button mt-4 mt-md-0" href="" target="_blank">Developer Email: computerscience2.10"gmail.com</a>
                  ...
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      ...
                      <div class="fluid-container">
                        <h3 class="font-weight-medium text-right mb-0">Ksh554 M</h3>
                      </div>
                    </div>
                  </div>
            ...
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
              <div class="card card-statistics">
                <div class="card-body">
                  ...
                  <p class="text-muted mt-3 mb-0">
                    <i class="mdi mdi-calendar mr-1" aria-hidden="true"></i> Sales
                  </p>
                </div>
              </div>
            </div>
                    ...
                    <table class="table table-bordered mt-3">
                      ...
                      @foreach($order->cart->items as $item)
                        <tr>
                          ...
                          <td>
                          Ksh{{ $item["pro_price"] }} M
                          </td>
                        </tr>                     
                        @endforeach 
                        <tr>
                          <td colspan="8" class="text-danger">
                          Total Price: Ksh{{ $order->cart->totalPrice }} M
                          </td>
                        </tr>  
                      </tbody>
                    </table>
          ...
          <div class="row">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title mb-4">Manage Comments</h5>
                  <div class="fluid-container">
                  @foreach($UserComments as $UserComment)
                    <div class="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
                      <div class="col-md-1">
                        <img class="img-sm rounded-circle mb-4 mb-md-0" src="{{asset('custome/img/pages/user.jpg')}}" alt="profile image">
                      </div>
                      <div class="ticket-details col-md-9">
                        <div class="d-flex">
                          <p class="text-dark font-weight-semibold mr-2 mb-0 no-wrap">{{$UserComment->name}} :</p>
                          <p class="text-primary mr-1 mb-0">[#{{$UserComment->id}}]</p>
                          <p class="mb-0 ellipsis">{{$UserComment->email}}</p>
                        </div>
                        ...
                        <div class="row text-gray d-md-flex d-none">
                          <div class="col-4 d-flex">
                            ...
                            <small class="Last-responded mr-2 mb-0 text-muted text-muted">{{$UserComment->created_at->diffForHumans()}}</small>
                          </div>
                          <div class="col-4 d-flex">
                            <small class="mb-0 mr-2 text-muted text-muted">Updated in :</small>
                            <small class="Last-responded mr-2 mb-0 text-muted text-muted">{{$UserComment->updated_at->diffForHumans()}}</small>
                          </div>
                        </div>
                      </div>
